...
class EndoTableViewCell: UITableViewCell {
    ...
    func configureCell(endoproject: EndoProject) {
        ...
        MS1StudentLabel.text = endoproject.MS1Name
        
        MS1Email.text = endoproject.MS1Email
        MS1StudentEmailLabel.text = endoproject.MS1Email
        
        MS2Name.text = endoproject.MS2Name
        MS2StudentLabel.text = endoproject.MS2Name
        
        MS2Email.text = endoproject.MS2Email
        MS2StudentEmailLabel.text = endoproject.MS2Email
        
        MS3Name.text = endoproject.MS3Name
        MS3StudentLabel.text = endoproject.MS3Name
        
        MS3Email.text = endoproject.MS3Email
        MS3StudentEmailLabel.text = endoproject.MS3Email
        
        MS4Name.text = endoproject.MS4Name
        MS4StudentLabel.text = endoproject.MS4Name
        
        MS4Email.text = endoproject.MS4Email
        MS4StudentEmailLabel.text = endoproject.MS4Email
    }
